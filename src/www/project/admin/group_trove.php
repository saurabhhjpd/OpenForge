...
// Lj new entry
//
print '<BR><h2>Project Categorization</h2><hr size="1" noshade="">';

print '<P>Please classifiy this project using each of the categorization methods given below. This will help potential developers and users in finding your project and engaging with it. If the project does not require any or all of these classification, simply select "None Selected". </P>';
