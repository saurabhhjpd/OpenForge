...
<div class="span12">
	...
	<div class="spandata">
    <h2 style="color: #4f8db3; font-size: 25px; font-weight: 700; margin-bottom: -12px;">About OpenForge</h2>
<hr noshade="">
		<p>
		...
		<p>
			<strong style="color: #4f8db3; font-weight: bold; margin-top: 25px; margin-bottom: 4px;">The platform has the following benefits:</strong>
		</P>
		<ol>
		...
		<p>
		<strong style="color: #4f8db3; font-weight: bold; margin-top: 25px; margin-bottom: 4px;">The following are the key stakeholders in the DigiLocker system:</strong>
        </p>
		<ul>
		...
		<p>
		<strong style="color: #4f8db3; font-weight: bold; margin-top: 25px; margin-bottom: 4px;">The main technology components of the DigiLocker system are:</strong>
