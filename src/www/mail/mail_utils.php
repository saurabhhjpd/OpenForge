...
// ';
echo '<h2>My Lists</h2><span class="line_breaker"> <B><A HREF="/mail/admin/?group_id='.$group_id.'&add_list=1">'.$Language->getText('mail_utils','add_list').'</A></B>
 | <B><A HREF="/mail/admin/?group_id='.$group_id.'&change_status=1">'.$Language->getText('mail_utils','update_list').'</A></B><P>(Mailing lists in OpenForge are provided via <a href="http://www.list.org">GNU Mailman</a>)</span> <hr size="1" noshade="">
';
	if ($params['help']) {
