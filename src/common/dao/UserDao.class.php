...
class UserDao extends DataAccessObject {
    ...
    */
     ...
     */
    function create($user_name, $email, $user_pw, $realname, $register_purpose, $status, $shell, $unix_status, $unix_uid, $unix_box, $ldap_id, $add_date, $confirm_hash, $mail_siteupdates, $agree_siteupdates, $mail_va, $sticky_login, $authorized_keys, $email_new, $timezone, $theme, $language_id, $expiry_date, $last_pwd_update) {
        ...
        if ($agree_siteupdates !== null) {
            $columns[] = 'agree_siteupdates';
            $values[]  = $agree_siteupdates;
        }
        if ($mail_va !== null) {
            $columns[] = 'mail_va';
            $values[]  = $mail_va;
